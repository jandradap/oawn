...
echo -e "\nIniciando servicios..."
openvassd --gnupg-home=/var/lib/openvas/openvasmd/gnupg --config-file=/etc/openvas/openvassd.conf --unix-socket=/var/run/openvassd.pid --listen-owner=root --listen-group=root &
